...
export const middleSchoolSchedule = [
  ...
  new ClassPeriod("Flag Raising/Assembly", "08:15", "08:45"),
  new ClassPeriod("1st Period", "08:50", "09:20", 1),
  new ClassPeriod("2nd Period", "09:25", "09:55", 2),
  new ClassPeriod("Break", "10:00", "10:10"),
  new ClassPeriod("3rd Period", "10:15", "10:45", 3),
  new ClassPeriod("4th Period", "10:50", "11:20", 4),
  new ClassPeriod("Lunch", "11:25", "12:05"),
  new ClassPeriod("5th Period", "12:10", "12:40", 5),
  new ClassPeriod("6th Period", "12:45", "13:15", 6),
  new ClassPeriod("7th Period", "13:20", "14:00", 7),
  new ClassPeriod("Advisory/US Assembly in Auditorium", "14:05", "14:50"),
];
...
export const highSchoolSchedule = [
  ...
  new ClassPeriod("Lunch", "12:10", "12:40"),
  new ClassPeriod("6th Period", "12:45", "13:15", 6),
  new ClassPeriod("7th Period", "13:20", "14:00", 7),
  new ClassPeriod("Advisory/US Assembly in Auditorium", "14:05", "14:50"),
];
